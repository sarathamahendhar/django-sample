...
tmp_dir=os.path.join(BASE_DIR,'usersproject')
TEMPLATE_DIR=os.path.join(tmp_dir,'templates')
SATATIC_DIR=os.path.join(tmp_dir,'static')
...
SECRET_KEY = '!6mzybr4r%wnn@3ak0lub1qxd%6i+!!ll+@y%dy^+fe(vc*-vm'
